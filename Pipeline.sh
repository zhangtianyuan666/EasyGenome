...
## Step03.Basic_Structual_and_Functional_Annotation
  ...
  cd ../
  # cog注释及作图 cog annotation and drawing
  mkdir cog;cd cog
  ...
  cd ../
  # GO注释及作图 GO annotation and drawing
  mkdir go;cd go
  ...
  cd ../
  # kegg注释及作图 kegg annotation and drawing
  mkdir kegg;cd kegg
  ...
  cd ../
  # tigerfam注释及作图 tigerfam annotation and drawing
...
## Step04.Advanced_functional_annotation
  ...
  # cazy注释及作图 cazy annotation and drawing
  # 创建分析目录
  mkdir cazy;
  cd cazy
  ...
  # tcdb注释及作图 tcdb annotation and drawing
  # 创建分析目录
  mkdir tcdb;cd tcdb
